			...
			<div className="header">
							...
							<Col sm={4}>
								{isLogged ? (
									<Row>
										...
										<Col sm={6}>
											<Nav className="mr-auto">
												<Nav.Link href="/home" onClick={this.logout} eventKey={2}>
													<Row>
														<Col sm={7}>
															<h3
																style={{
				...
				<Navbar collapseOnSelect expand="lg" className={'nav-down'}>
					{isLogged && type === 'client' ? (
						<>
							...
							<Navbar.Collapse id="responsive-navbar-nav">
								<Nav className="mr-auto">
									<NavDropdown title="Produtos" id="collasible-nav-dropdown" noCaret>
										{/* {
                                            data.map((item, index) => {
                                                return(
					...
					{isLogged && type === 'producer' ? (
						<>
							<Nav.Link href="/dashboardproducer" style={{ color: 'white', marginLeft: 20 }}>
								Home
							</Nav.Link>
