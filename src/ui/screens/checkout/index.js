		...
		return (
			<div>
				<Card className="text-center text-white">
					<Card.Img src={images.thanks} alt="Card image" />
					<Card.ImgOverlay style={{ marginTop: 180 }}>
						<Card.Title style={{ fontSize: 80, marginBottom: 200, color: 'white' }}>
						...
						>
							...
							>
								<Card.Text style={{ marginTop: 15 }}>O seu número de encomenda é #{number},</Card.Text>
