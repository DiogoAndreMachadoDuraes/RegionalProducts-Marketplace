	...
	return (
		<>
				...
				<Container id="list-group-tabs-example">
					<Row id="row" style={{ marginTop: 50 }}>
						...
						<Col sm={5} style={{ marginTop: 80 }}>
							<h5 style={{ color: 'black', textAlign: 'justify' }}>
			...
			<div style={{ marginTop: 50, marginBottom: 90, textAlign: 'center' }}>
				<h2 style={{ color: 'black', marginBottom: 25, marginTop: 10 }}>Contactos</h2>
				<h6 style={{ color: '#AA3C3C' }}>Se tiver alguma questão entre em contacto.</h6>
				<Container id="list-group-tabs-example">
					<Row id="row" style={{ marginTop: 50 }}>
						<Col sm={6} lg={6}>
					...
					<Row id="row" style={{ marginTop: 5 }}>
						<Col sm={6} lg={6}>
							<a href="tel:+351913157290" style={{ fontWeight: 'bold', fontSize: 16, color: 'black' }}>
								+351 913 157 290
							</a>
						</Col>
						<Col sm={6} lg={6}>
