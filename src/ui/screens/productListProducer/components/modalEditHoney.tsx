...
interface ModalEditHoneyProps {
	showModalEditHoney: boolean;
...
export const ModalEditHoney: React.FC<ModalEditHoneyProps> = ({
	activeItemQuantity,
	activeItemID,
	activeItemValidity,
	activeItemPhoto,
			...
			<Modal.Body>
				...
				<Row>
					<Col>
						<Form>
							<Form.Group>
								<Form.File onChange={handlePhoto} id="exampleFormControlFile1" label="Inserir foto" />
							</Form.Group>
						</Form>
					</Col>
					<Col>
				...
				<Row style={{ marginTop: 20 }}>
					<Button
						type="submit"
						/* onClick={() => handleSubmit(activeItemID)} */ variant="primary"
						size="lg"
						block
					>
						Alterar
