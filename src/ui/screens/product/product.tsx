  ...
  return ( <>
    ...
    <div>
          <Breadcrumb
           /*  width="300"
            height="300" */
            style={{ marginTop: 20, marginLeft: 28/* , boxShadow:'rgba(117,0,0,0.5)' */ }}
            id="breadcrumb"
          >
        ...
        <br />
        <Container >
          <h1 style={{fontFamily: "artifika", color: "#9B3939" }} /* class="text-left" */> Compotas </h1>
          <br />
          <Row>
            <CardGroup>
              <Card>
                ...
                <Card.Body style={{color:'#9B3939', flexDirection:'column', fontFamily: "artifika", alignItems:'center', justifyItems:'center', display:'flex'}}>
              ...
              <Card>
                ...
                />
                <Card.Body style={{color:'#9B3939', fontFamily: "artifika", flexDirection:'column', alignItems:'center', justifyItems:'center', display:'flex'}}>
              ...
              <Card>
                ...
                <Card.Body style={{color:'#9B3939', flexDirection:'column', fontFamily: "artifika", alignItems:'center', justifyItems:'center', display:'flex'}}>
                  ...
                  <Button href="/cart" variant="secondary">Adicionar ao Carrinho</Button>
                </Card.Body>
              </Card>
              <Card>
                <Card.Title className="text-right" style={{ marginRight: 10 }}>
