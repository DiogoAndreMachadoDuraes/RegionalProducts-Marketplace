...
Declinamos a responsabilidade por eventuais danos decorrentes do uso indevido ou negligente da palavra-chave definida pelo Utilizador para acesso à sua conta. O Utilizador deverá assegurar a confidencialidade da respetiva palavra-chave.

O Utilizador Registado terá acesso a uma área pessoal, com os dados que tiver indicado no momento do registo.
Através do registo, o Utilizador poderá aceder aos dados da sua conta e proceder à sua alteração ou eliminação definitiva. Pode consultar as suas encomendas, devoluções e comunicações com a empresa.

No Site encontram-se disponíveis os produtos comercializados pelos Produtos Regionais. A informação sobre os produtos apresentada no Site destina-se apenas a fornecer um breve resumo informativo para melhor conveniência e informação do visitante.
...
- As fotografias apresentadas no Site têm caráter meramente ilustrativo, devendo consultar informação detalhada sobre os produtos e as respetivas caraterísticas/especificações;
...
- Não garantimos a existência em stock dos artigos incluídos no Site, nem tão pouco assumimos a responsabilidade por artigos descontinuados.
					...
					A loja Produtos Regionais responsabiliza-se pela entrega dos produtos em boas condições.
Na eventualidade das encomendas não serem entregues nas devidas condições, o cliente deverá informar a transportadora no acto da entrega e por escrito, ficando com uma evidência na sua posse. De seguida deverá enviar um email para geral@regional.pt informando o sucedido e com a prova da observação.
Após análise, será dado ou não deferimento à reclamação. Nos casos de deferimento da reclamação, a loja Produtos Regionais concederá ao cliente um crédito igual ao valor do produto, que deverá ser utilizado na compra de qualquer outro produto disponível na loja, ou encontrará uma solução que seja de acordo do cliente.
Eventuais atrasos na entrega são alheios aos Produtos Regionais.
					...
					<p style={{ textAlign: 'justify', fontFamily:'Artifika'  }}>
					A devolução de produtos alimentares obedece ao DL nº 24/2014, Art. 17º.
A devolução do produtos não alimentares têm os custos de envio por conta do cliente.
O cliente poderá resolver o contrato sem pagamento de indemnização e sem necessidade de indicar o motivo, no prazo de 14 dias a partir da receção do produto.
...
Quando o direito de livre resolução tiver sido exercido pelo cliente nos termos do acima exposto, os Produtos Regionais efetuará o reembolso dos montantes pagos pelo cliente pelo meio que entender mais adequado.
					</p>
					<br />
					<br />
				</Col>
