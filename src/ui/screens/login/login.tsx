...
import { InputGroup, Image, Row, Col, Form, Navbar, Container, Button, Alert } from 'react-bootstrap';
	...
	return (
		<>
			<Alert key={'danger'} variant={'danger'} show={isInvalidCredentials} style={{ textAlign: 'center' }}>
				O email e/ou palavra-passe estão incorretos!
			</Alert>
				...
				<div style={{ display: 'flex', flexDirection: 'row' }}>
					...
					>
						...
						<Form
							inline
							autoComplete="off"
							style={{ padding: 20, marginTop: 45, justifyContent: 'center' }}
						>
