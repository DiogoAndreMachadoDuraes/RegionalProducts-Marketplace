...
import { InputGroup, Image, Row, Col, Button, Form, Container, Navbar } from 'react-bootstrap';
		...
		return (
			<Container id="list-group-tabs-example" defaultActiveKey="#link1">
				<Row id="row">
						...
						<Form inline autoComplete="off">
							...
							<Row id="row" style={{ marginTop: 10 }}>
								...
								<Col sm={10}>
									...
									>
										<Form.Check type="checkbox" label="Lembrar-me" style={{ color: 'black' }} />
									</Form.Group>
								</Col>
								<Col sm={1} />
							</Row>
							...
							<Row id="row" style={{ marginLeft: 10 }}>
								...
								<Col sm={9} style={{ color: '#444903', fontFamily: 'artifika' }}>
									<Navbar.Text>
										<a style={{ color: '#444903', fontFamily: 'artifika' }} href="ForgetPassword">
							...
							<Row id="row" style={{ marginTop: -15, marginLeft: 18 }}>
								...
								<Col sm={9} style={{ color: '#444903', fontFamily: 'artifika' }}>
									<h7> Não tem conta? </h7>
									<Navbar.Text>
										<a style={{ color: '#444903', fontFamily: 'artifika' }} href="Register">
											Registe-se!
										</a>
									</Navbar.Text>
								</Col>
					...
					<Col sm={6}>
						<Image src={images.menu} width="768" height="721" />
					</Col>
				</Row>
			</Container>
		);
